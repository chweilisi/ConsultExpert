...
//        try {
//            File file = new File(Constants.VOICE_CACHE_DIR + CommonUtils.md5(UserManager.getInstance().getCurrentUserObjectId()) + File.separator + uid + File.separator + createTime + ".amr");
//            if (!file.exists()) {
//                file.createNewFile();
//            }
...
//        File file = newFile(Constants.VOICE_CACHE_DIR + CommonUtils.md5(UserManager.getInstance().getCurrentUserObjectId()) + File.separator + uid
