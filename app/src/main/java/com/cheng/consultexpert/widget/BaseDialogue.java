...
public class BaseDialogue extends Dialog {
    ...
    public BaseDialogue(Context context) {
        this(context, R.style.dialog_default_style);
    }

    private BaseDialogue(Context context, int themeResId) {
     ...
     * @param layoutId 布局ID
     */
    public BaseDialogue setDialogContentView(int layoutId) {
    ...
    public BaseDialogue setDialogContentView(View view) {
        if (middleLayout.getChildCount() > 0) {
            middleLayout.removeAllViews();
        }
     ...
     * @param title 标题
     */
    public BaseDialogue setTitle(String title) {
        if (title == null) {
     ...
     */
    public BaseDialogue setDialogTopView(int layoutId) {
     ...
     */
    public BaseDialogue setDialogBottomView(int layoutId) {
    ...
    public BaseDialogue setMessage(String message) {
        this.message.setText(message);
        return this;
    }


    public BaseDialogue setLeftButton(String name, View.OnClickListener listener) {
        left.setText(name);
        left.setOnClickListener(listener);
        return this;
    }

    public BaseDialogue setRightButton(String name, View.OnClickListener listener) {
        right.setText(name);
     ...
     * @return this
     */
    public BaseDialogue setEditViewsName(List<String> names) {
        if (middleLayout.getChildCount() > 0) {
            middleLayout.removeAllViews();
        }
    ...
    public BaseDialogue setCheckBoxName(List<String> list) {
        if (middleLayout.getChildCount() > 0) {
            middleLayout.removeAllViews();
        }
        for (String title :
    ...
    public BaseDialogue setBottomLayoutVisible(boolean visible) {
